...
class _DashboardTabState extends State<DashboardTab> {
          ...
          LocalAiClassifier.benchmarks.entries.map((e) {
            return {
              ...
              'recycler_offered_price_per_kg':
                  (e.value['rate_per_kg'] as num).toDouble(),
            };
          }).toList()
            ..sort(
              (a, b) =>
  ...
  // Opens the complete Market Rates page.
  ...
  // Opens the complete Recycler Nearby page.
  void _openRecyclerNearby() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => RecyclerNearbyScreen(
          language: widget.language,
        ),
      ),
    );
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    activeAccent.withValues(alpha: 0.85),
                    activeAccent,
                  ],
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: InkWell(
                    onTap:
                        _pendingSyncCount > 0 ? _triggerManualSync : null,
